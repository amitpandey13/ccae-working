 ...
 * 
 * <ul>
 * <li> checkedIn exhibition license 4/15/20 - 6/14/32, genreId (1, 2)
 ...
 *
 */
public class CarveOutSubsetGenre extends ConflictCalculationTest {
	...
	public void exhibitionExclusivityLicenseTest() {
		...
		customer1.getCustomerGenres().add(dummyCustomerGenre2);

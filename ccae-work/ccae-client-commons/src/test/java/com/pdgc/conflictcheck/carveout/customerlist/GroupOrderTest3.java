 ...
 * <li> checkedIn exhibition license 4/15/20 - 6/14/32, customerId 3
 * <li> checkedOut exclusivity license 4/15/21 - 6/14/25 
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, customerId 1, AND, ORDER 1 
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, customerId 2, OR , ORDER 2
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, customerId (1,2,3), AND , ORDER 3
 * </ul> 
 * 
 * <p>
 * 
...
public class GroupOrderTest3 extends ConflictCalculationTest {
	...
	public void exhibitionExclusivityLicenseTest() {
		...
		carveOuts.add(CustomerCarveOut.builder()
            	...
            	.carveOutType(FoxCarveOutType.CUSTOMERS)
            	.origTerm(exclusivityLicense1.getTerm()) 
            	.carveOutCustomers(Arrays.asList(dummyCustomer, dummyCustomer2, dummyCustomer3)) 
            	.carveOutImpactType(CarveOutImpactType.EXCEPT_AGAINST) 
            	.carveOutCombineRule(CarveOutCombineRule.AND)
            	.carveOutOrder(3)
            	.carveOutGroupId(1)

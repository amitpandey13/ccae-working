 ...
 * 
 * <ul>
 * <li> checkedIn exhibition license 4/15/20 - 6/14/32, TypeId (1, 2)
 ...
 *
 */
public class CarveOutSubsetType extends ConflictCalculationTest {
	...
	public void exhibitionExclusivityLicenseTest() {
		...
		customer1.getCustomerTypes().add(dummyCustomerType2);

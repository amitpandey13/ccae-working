 ...
 * <p>
 * <ul>
 * <li> checkedIn exhibition license 4/15/20 - 6/14/32, customerTypeId 1
 * <li> checkedOut exclusivity license 4/15/21 - 6/14/25 
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, customerTypeId 1
 * </ul> 
 * <p>
 * 
 ...
 *
 */
public class ValidCustomerTypeCarveOut extends ConflictCalculationTest {
	...
	public void exhibitionExclusivityLicenseTest() {
		...
		exclusivityLicense1.setCarveOuts(new FoxCarveOutContainer(
	        	...
	        	Collections.singleton(new CarveOutGroup(
		        		...
		        		1,
		        		1,
	        		Sets.newHashSet(CustomerTypeCarveOut.builder()
	                    	.carveOutId(1L) 

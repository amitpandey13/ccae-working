 ...
 * <li> checkedIn exhibition license 4/15/20 - 6/14/32, genreId 3
 * <li> checkedOut exclusivity license 4/15/21 - 6/14/25 
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, genreId 1, AND, ORDER 1 
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, genreId 2, OR , ORDER 2
 * <li> checkedOut carveOut on exclusivity 4/15/21 - 6/14/25, genreId (1,2,3), AND , ORDER 3
 * </ul> 
 * 
 * <p>
 * 
...
public class GroupOrderTest3 extends ConflictCalculationTest {
	...
	public void exhibitionExclusivityLicenseTest() {
		...
		customer3.getCustomerGenres().add(dummyCustomerGenre3);
		...
		carveOuts.add(CustomerGenreCarveOut.builder()
            	...
            	.carveOutComment("dummy customer carveOut 1")
		...
		carveOuts.add(CustomerGenreCarveOut.builder()
            	...
            	.carveOutType(FoxCarveOutType.CUSTOMERS)
            	.origTerm(exclusivityLicense1.getTerm()) 
            	.carveOutComment("dummy customer carveOut 2")
		...
		carveOuts.add(CustomerGenreCarveOut.builder()
            	...
            	.carveOutType(FoxCarveOutType.CUSTOMERS)
            	.origTerm(exclusivityLicense1.getTerm()) 
            	.carveOutComment("dummy customer carveOut 3")
            	.carveOutGenres(Arrays.asList(dummyCustomerGenre1, dummyCustomerGenre2, dummyCustomerGenre3)) 
            	.carveOutImpactType(CarveOutImpactType.EXCEPT_AGAINST) 
            	.carveOutCombineRule(CarveOutCombineRule.AND)
            	.carveOutOrder(3) 
            	.carveOutGroupId(1) 

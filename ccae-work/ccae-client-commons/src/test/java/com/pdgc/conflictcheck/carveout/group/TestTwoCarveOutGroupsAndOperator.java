 ...
 *
 */
public class TestTwoCarveOutGroupsAndOperator extends ConflictCalculationTest {
	
	@Test
	public void passGroup1AndFailGroup2_shouldConflict() {
		// license 1
	...
	@Test
	public void passGroup1AndPassGroup2_shouldPass() {
		// license 1
		TestDealStrand exhibitionLicense1 = new TestDealStrand(simpleEpisodeLicense);
		exhibitionLicense1.setTerm(new Term(DateTimeUtil.createDate(2020, 4, 15), DateTimeUtil.createDate(2032, 6, 14)));
		exhibitionLicense1.setRightType(TestRightType.NONEXCLUSIVE_LICENSE);
	...
	@Test
	public void partialPassGroup1AndPartialPassGroup2_shouldPartialConflict() {
		// license 1
		TestDealStrand exhibitionLicense1 = new TestDealStrand(simpleEpisodeLicense);
		exhibitionLicense1.setTerm(new Term(DateTimeUtil.createDate(2020, 4, 15), DateTimeUtil.createDate(2032, 6, 14)));
		exhibitionLicense1.setRightType(TestRightType.NONEXCLUSIVE_LICENSE);

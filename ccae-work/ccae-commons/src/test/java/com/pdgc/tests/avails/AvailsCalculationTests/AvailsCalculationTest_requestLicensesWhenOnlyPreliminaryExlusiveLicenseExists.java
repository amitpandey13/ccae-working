...
public class AvailsCalculationTest_requestLicensesWhenOnlyPreliminaryExlusiveLicenseExists extends AvailsCalculationTest {
	/* Basic Test For preliminary Exclusive License
	 * request licenses when only preliminary exclusive right exists
	 *
	 *
	 */
	@Test
	public void requestLicensesWhenOnlyPreliminaryExlusiveLicenseExists() throws FileNotFoundException {
		...
		rightsIn.setRightType(TestRightType.PRELIM_EXCLUSIVE_LICENSE);

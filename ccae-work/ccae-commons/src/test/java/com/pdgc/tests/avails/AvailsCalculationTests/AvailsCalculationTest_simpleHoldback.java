...
public class AvailsCalculationTest_simpleHoldback extends AvailsCalculationTest {
	 ...
	 */
	@Test
	public void simpleHoldbackTest() throws FileNotFoundException {
		TestDistributionStrand USEnglishBASCDistributionRights = new TestDistributionStrand(

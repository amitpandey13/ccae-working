...
public class AvailsCalculationTest_requestLicensesWhenExclusiveDistributionRightAndPreliminaryExclusiveRightExists extends AvailsCalculationTest {
	/*
	 * request Licenses when Exclusive Distribution Right AND Preliminary Exclusive Right Exists
	 *
	 */
	@Test
	public void requestLicensesWhenExclusiveDistributionRightAndPreliminaryExclusiveRightExists() throws FileNotFoundException {

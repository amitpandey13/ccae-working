...
public class ConflictCalculationTest_overrideExplosion extends ConflictCalculationTest {
	...
	@Test
	public void overrideExplosionTest() {
		...
		ConflictOverride seasonWorldOverride = new ConflictOverride(
			1L, 
			1L,
			new ConflictOverrideType(-1, "randomType"),

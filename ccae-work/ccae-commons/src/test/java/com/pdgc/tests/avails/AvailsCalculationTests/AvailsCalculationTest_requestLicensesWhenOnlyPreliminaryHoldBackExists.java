...
public class AvailsCalculationTest_requestLicensesWhenOnlyPreliminaryHoldBackExists extends AvailsCalculationTest {
	/*Basic test for preliminary holdBack license
	 * request licenses when only preliminary holdBack license exists
	 *
	 *
	 */
	@Test
	public void  requestLicensesWhenOnlyPreliminaryHoldBackExists() throws FileNotFoundException {
		...
		rightsIn.setRightType(TestRightType.PRELIM_HOLDBACK);

...
public class ConflictCalculationTest_overridePerfectlyMatchSeasonLevel extends ConflictCalculationTest {
	// Test that an override that perfectly matches a conflict is properly
	// applied to the conflict (this refers to dates since leafConflicts exist
	// at leaf-level, so there is no concept of partial matching)
	@Category(Categories.OverrideReApply.class)
	@Test
	public void overridePerfectlyMatchSeasonLevelTest() {

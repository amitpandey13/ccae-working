...
public class ConflictRollupTest_ep1FullRemainderPartialMediaProductFirst extends ConflictRollupTest {
	//Ep 1 has all the children of ptv
	//All other episodes in season 1 contain 2 out of the 3 ptv children
	//Rollup order does product first, then media
	@Test
	public void ep1FullRemainderPartialMediaProductFirstTest()
	{
		...
		
		{
			...
			sourceMedias = Collections.singleton(ptvm);
			sourceTerritories = Collections.singleton(dallas);
			sourceLanguages = Collections.singleton(english);

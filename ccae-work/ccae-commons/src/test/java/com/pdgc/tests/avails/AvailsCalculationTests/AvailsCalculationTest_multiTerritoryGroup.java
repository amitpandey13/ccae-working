...
public class AvailsCalculationTest_multiTerritoryGroup extends AvailsCalculationTest {

	/*
	 * multiple territory groups, each with multiple terr/langs and multiple
	 * media/right scope combinations, no overlapping terrlangs across groups
	 * multiple territory groups, each with multiple terr/langs and multiple
	 * media/right scope combinations, no overlapping terrlangs across groups
	 */
	@Test
	public void multiTerritoryGroupTest() throws FileNotFoundException {
...

		{
			...
			USEnglishPTVDistributionRights.setActualMTL(new MTL(ptv, usa, english));
			USEnglishPTVDistributionRights.setMTL(new MTL(ptv, usa, english));

			USSpanishPTVDistributionRights.setRightStrandId(2L);
			USSpanishPTVDistributionRights.setActualMTL(new MTL(ptv, usa, spanish));
			USSpanishPTVDistributionRights.setMTL(new MTL(ptv, usa, spanish));

			USFrenchPTVDistributionRights.setRightStrandId(3L);
			USFrenchPTVDistributionRights.setActualMTL(new MTL(ptv, usa, french));
			USFrenchPTVDistributionRights.setMTL(new MTL(ptv, usa, french));

			USEnglishBASCDistributionRights.setRightStrandId(4L);
			USEnglishBASCDistributionRights.setActualMTL(new MTL(basc, usa, english));
			USEnglishBASCDistributionRights.setMTL(new MTL(basc, usa, english));

			USSpanishBASCDistributionRights.setRightStrandId(5L);
			USSpanishBASCDistributionRights.setActualMTL(new MTL(basc, usa, spanish));
			USSpanishBASCDistributionRights.setMTL(new MTL(basc, usa, spanish));

			USFrenchBASCDistributionRights.setRightStrandId(6L);
			USFrenchBASCDistributionRights.setActualMTL(new MTL(basc, usa, french));
			USFrenchBASCDistributionRights.setMTL(new MTL(basc, usa, french));

			MexicoEnglishPPVDistributionRights.setRightStrandId(7L);
			MexicoEnglishPPVDistributionRights.setActualMTL(new MTL(ppv, mexico, english));
			MexicoEnglishPPVDistributionRights.setMTL(new MTL(ppv, mexico, english));

			MexicoSpanishPPVDistributionRights.setRightStrandId(8L);
			MexicoSpanishPPVDistributionRights.setActualMTL(new MTL(ppv, mexico, spanish));
			MexicoSpanishPPVDistributionRights.setMTL(new MTL(ppv, mexico, spanish));

			CanadaEnglishPTVDistributionRights.setRightStrandId(9L);
			CanadaEnglishPTVDistributionRights.setActualMTL(new MTL(ptv, canada, english));
			CanadaEnglishPTVDistributionRights.setMTL(new MTL(ptv, canada, english));

			CanadaFrenchPTVDistributionRights.setRightStrandId(10L);
			CanadaFrenchPTVDistributionRights.setActualMTL(new MTL(ptv, canada, french));
			CanadaFrenchPTVDistributionRights.setMTL(new MTL(ptv, canada, french));

			CanadaEnglishBASCDistributionRights.setRightStrandId(11L);
			CanadaEnglishBASCDistributionRights.setActualMTL(new MTL(basc, canada, english));
			CanadaEnglishBASCDistributionRights.setMTL(new MTL(basc, canada, english));

			CanadaFrenchBASCDistributionRights.setRightStrandId(12L);
			CanadaFrenchBASCDistributionRights.setActualMTL(new MTL(basc, canada, french));
			CanadaFrenchBASCDistributionRights.setMTL(new MTL(basc, canada, french));

			USEnglishPTVEpisode1License.setRightStrandId(13L);
			USEnglishPTVEpisode1License.setActualMTL(new MTL(ptv, usa, english));
			USEnglishPTVEpisode1License.setMTL(new MTL(ptv, usa, english));
			...
			MexicoSpanishPPVEpisode1Holdback.setActualMTL(new MTL(ppv, mexico, spanish));
			MexicoSpanishPPVEpisode1Holdback.setMTL(new MTL(ppv, mexico, spanish));
			...
			CanadaFrenchBASCEpisode1TetheredVOD.setActualMTL(new MTL(basc, canada, french));
			CanadaFrenchBASCEpisode1TetheredVOD.setMTL(new MTL(basc, canada, french));
		...
		List<RightStrand> rightStrands = Arrays.asList(
			...
			CanadaEnglishBASCDistributionRights, CanadaFrenchBASCDistributionRights, 
			USEnglishPTVEpisode1License, MexicoSpanishPPVEpisode1Holdback, CanadaFrenchBASCEpisode1TetheredVOD
		);

...
public class AvailsCalculationTest_multiParentProductMultiSeasonLicenseTest extends AvailsCalculationTest{
	/* 
	 * Tests product with multiple parents i.e. episode that is 2 episodes combined but sold as 1.
	 * Seinfeld Episode 01 and Seinfeld Episode 02 are separate episodes. 
	 * Seinfeld Episode 01+02 is a 1hr episode with a different product id. 
	 * In the product hierarchy, its parents are Seinfeld Episode 01 and Seinfeld Episode 02. 
	 * 
	 * License is taken out Seinfeld Episode 01.
	 * Search for availability on Episode 01+02 returns unavailable.   
	 */
	@Test

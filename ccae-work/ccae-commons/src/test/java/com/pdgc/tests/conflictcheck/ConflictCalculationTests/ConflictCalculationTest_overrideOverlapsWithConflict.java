...
public class ConflictCalculationTest_overrideOverlapsWithConflict extends ConflictCalculationTest {
	// Test that an override that overlaps with but neither fully encompasses or
	// is fully encompassed within a conflict will still be applied to the
	// conflict (this refers to dates since leafConflicts exist at leaf-level,
	// so there is no concept of partial matching)
	@Category(Categories.OverrideReApply.class)
	@Test
	public void overrideOverlapsWithConflict() {

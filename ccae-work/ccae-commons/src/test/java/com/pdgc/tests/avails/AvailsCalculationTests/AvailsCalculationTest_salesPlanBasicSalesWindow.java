...
public class AvailsCalculationTest_salesPlanBasicSalesWindow extends AvailsCalculationTest {

	/*
	 * Basic Sales Plan Window - blocks out other licenses from the specified PMTL &
	 * time period
	 */
	@Test
	public void salesPlanBasicSalesWindowTest() throws FileNotFoundException {
		...
		salesPlanBlock.setMedia(basc);
		//salesPlanBlock.setParentSource(salesWindows.getRightSourceId());
		...
		List<RightStrand> rightStrands = Arrays.asList(allMediaDistrRights, salesPlanWindow);

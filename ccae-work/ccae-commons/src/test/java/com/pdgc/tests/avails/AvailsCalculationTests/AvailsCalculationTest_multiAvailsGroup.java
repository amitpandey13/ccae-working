...
public class AvailsCalculationTest_multiAvailsGroup extends AvailsCalculationTest {
	//multiple avails groups, each with multiple terr/langs and multiple media/right scope combinations, no overlapping terrlangs across groups
    @Test
    public void multiAvailsGroupTest() throws FileNotFoundException
    {
        ...
        {
            int keyId = 1; 
            Set<CriteriaSource> criteriaSources = ImmutableSet.of(

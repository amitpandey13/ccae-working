...
public class ConflictRollupTest_terrLangLanguageFirst extends ConflictRollupTest {
	 ...
	 * This is the language first test, so results should be
	 * New York/All, US markets (minus New York)/French,Spanish
	 */
	@Test
	public void terrLangLanguageFirstTest() {
		...
		List<RollupType> rollupOrder = Arrays.asList(RollupType.LANGUAGE, RollupType.TERRITORY);
		...
		
		{
			...
			sourceLanguages = Collections.singleton(Constants.ALL_LANGUAGES);

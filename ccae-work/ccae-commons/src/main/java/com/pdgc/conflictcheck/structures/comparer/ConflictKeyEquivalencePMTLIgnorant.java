...
public class ConflictKeyEquivalencePMTLIgnorant extends Equivalence<ConflictKey> {
	
	private ConflictKeyEquivalencePMTLTimeIgnorant childEquivalence;
	
	public ConflictKeyEquivalencePMTLIgnorant() {
		this(Equivalence.equals());
	}	
	
	public ConflictKeyEquivalencePMTLIgnorant(Equivalence<? super ConflictSourceGroupKey> groupKeyEquivalence) {

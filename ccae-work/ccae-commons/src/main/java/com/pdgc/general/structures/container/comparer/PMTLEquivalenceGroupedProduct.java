...
public class PMTLEquivalenceGroupedProduct extends Equivalence<PMTL>{
	...
	protected boolean doEquivalent(PMTL left, PMTL right) {
        ...
        return Objects.equals(left.getMedia(), right.getMedia())
	...
	protected int doHash(PMTL obj) {
		return Objects.hashCode(obj.getMedia())
